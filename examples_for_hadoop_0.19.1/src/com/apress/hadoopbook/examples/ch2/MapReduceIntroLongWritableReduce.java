...
/** A modification of MapReduceIntro.java  To numerically sort the input keys and to merge the values of the keys into a CSV style record.
 * 
 ...
 *
 */
public class MapReduceIntroLongWritableReduce {
    protected static Logger logger = Logger.getLogger(MapReduceIntroLongWritableReduce.class);
    ...
    public static void main(final String[] args) {
        try {
             ...
             */
            final JobConf conf = new JobConf(MapReduceIntroLongWritableReduce.class);
            ...
            /** Inform the framework that the reducer class will be the {@link MergeValuesToCSVReducer}.
             ...
             */
            conf.setReducerClass(MergeValuesToCSVReducer.class);
