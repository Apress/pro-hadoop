...
/** A modification of MapReduceIntro.java that attempts a naive way of having the reduce output sorted numerically.
 * 
 ...
 *
 */
public class MapReduceIntroLongWritable {
    protected static Logger logger = Logger.getLogger(MapReduceIntroLongWritable.class);
    ...
    public static void main(final String[] args) {
        try {
             ...
             */
            final JobConf conf = new JobConf(MapReduceIntroLongWritable.class);
