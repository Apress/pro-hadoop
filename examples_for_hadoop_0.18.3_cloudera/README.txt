...
hadoop 18.3 does not support a number of features and to simpilify the eclipse installation those files have been removed from this bundle.
In particular ch8 and ch9's source are not present and the cloudera patched hadoop source is also not present. Their bundle is available at their website. The cloudera source rpm is in the apache_licensed_lib directory.
